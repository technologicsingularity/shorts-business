...
media = MediaFileUpload('/data/.openclaw/workspace/phone_heat_video_fixed.mp4', mimetype='video/mp4', resumable=True)

request = youtube.videos().insert(part='snippet,status', body=body, media_body=media)

print('Uploading CORRECTED phone heat video...')
response = None
...
print('Status: PUBLIC')
print('Note: This version has the correct phone/battery background!')
