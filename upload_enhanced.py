...
media = MediaFileUpload('/data/.openclaw/workspace/smoke_detector_enhanced.mp4', mimetype='video/mp4', resumable=True)

request = youtube.videos().insert(part='snippet,status', body=body, media_body=media)

print('Uploading enhanced smoke detector video...')
response = None
